...
ggplot(prob_df, aes(x)) +
  ...
  scale_x_continuous(limits = c(-8000, 2500),
                     breaks = c(-8000, -6500, -5000, -3500, -2000, -500, 1000, 2500)) +
  #theme_dviz_open(20) +
  ...
  theme_minimal() +
  annotate("text", label = "District 2", x = -6500, y = .5, color = "gray40", size = 8) +
  annotate("text", label = "District 1", x = 1500, y = .5, color = "gray40", size = 8)
```
